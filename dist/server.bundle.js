...
var url = _interopRequireWildcard(__webpack_require__(6));

var _lruCache = _interopRequireDefault(__webpack_require__(7));
...
app.get('*', function (req, res) {
  ...
  var page = parsedUrl.pathname === '/' ? 'home' : parsedUrl.pathname.substr(1);
  var initialData = {
    page: page
  };
...
var _App = _interopRequireDefault(__webpack_require__(10));
...
var _About = _interopRequireDefault(__webpack_require__(12));
...
function About() {
  return /*#__PURE__*/_react["default"].createElement("div", null, "This is about page");
}
